...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *                                                                               generated by [keymapviz] */
    [BASE] = LAYOUT_split_3x6_3(
        ...
        KC_ESCAPE,   DK_Z,    DK_X,    DK_C,    DK_V,    DK_B,                                 DK_N,    DK_M,    DK_COMM, DK_DOT,  DK_MINS, KC_LGUI,
                                        KC_LALT, KC_SPC, KC_LCTL,                    KC_ENT, LT(MISC, KC_BSPC), OSL(SYMBOL) 
    ),
    ...
    *                                                                               generated by [keymapviz] */
    [MISC] = LAYOUT_split_3x6_3(
        ...
        KC_CAPS, _______, _______, _______, KC_VOLU, KC_DEL,                                 KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_INS, KC_F12,
    ...
    *                                                                               generated by [keymapviz] */
    [SYMBOL] = LAYOUT_split_3x6_3(
        ...
        _______, DK_QUES,  DK_PERC,  DK_CIRC,  OSL(RIGHT),  DK_ASTR,                DK_PLUS, DK_DLR, _______, _______, _______, _______,
                                        TO(MISC), TO(BASE), _______,         _______, KC_BSPC, TO(SYMBOL)
    ),
    ...
    *                                                                               generated by [keymapviz] */
    [LEFT] = LAYOUT_split_3x6_3(
        ...
        _______, _______,  _______,  DK_LCBR,  _______,  _______,                _______, _______, _______, _______, _______, _______,
                                           _______, TO(BASE), _______,        _______, KC_BSPC, TO(SYMBOL)
    ),
